...
mioServer.createServer((req, res) => {
    ...
    res.write("Giorno della settimana: " + today.getDay() + '<br/>')
    res.write("Data: " + today.getDate() + "/" + today.getMonth() + "/" + today.getFullYear() + '<br/>')
    res.write("Ora: " + today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds() + '<br/>')
