    ...
    .then((misure)=> {
        ...
        for (var misura of misure)  {
            ...
            div_row.innerHTML = "<div class=\"row\">" + 
                ...
                "<div class=\"col-sm-3 bg-secondary border d-flex justify-content-center\">" + cleanTemperature(misura.data.sht30n1.lowRes.temperature) + "</div>" +
                "<div class=\"col-sm-3 bg-info border d-flex justify-content-center\">" + misura.data.sht30n1.lowRes.humidity + "</div>" +
                "</div>";
