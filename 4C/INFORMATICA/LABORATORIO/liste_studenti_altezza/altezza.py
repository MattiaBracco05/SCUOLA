#4C Bracco Mattia - Registrare altezze studenti
MAX_ALTEZZA = 200
MIN_ALTEZZA = 140
MAX_ALUNNI = 20
MIN_ALUNNI = 2
...
for i in range (N):
	...
	altezza = int(input("Inserire l'altezza del " + str(i+1) + "° studente in cm: "))
	#controllo che l'altezza sia nel range
	while not MIN_ALTEZZA <= altezza <= MAX_ALTEZZA:
		altezza = int(input("ERRORE! (l'altezza deve essere compreso tra " + str(MIN_ALTEZZA) + " cm e " + str(MAX_ALTEZZA) + " cm)\nInserire l'altezza del " + str(i+1) + "° studente in cm: "))
