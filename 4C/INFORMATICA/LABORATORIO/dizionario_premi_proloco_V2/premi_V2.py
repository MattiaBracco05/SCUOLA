...
def sorteggiaPremio():
	...
	#sorteggio premio random
	print("Sorteggio random in corso...")
	premioRandom = random.choice(list(premi.values()))
	print(premioRandom)
	
	#ricerco la posizione del premio sorteggiato
	for chiave in premi:
		if premioRandom == premi[chiave]:
			pos = chiave
			
	#elimino il premio sorteggiato
	del premi[pos]
