...
print("|                                     |")
print("|     STORICO DELLE PRENOTAZIONI      |")
print("|_____________________________________|")
pickleRegistro = open ("EmpID.pickle", "rb")
datiRegistro = pickle.load(pickleRegistro)
print(datiRegistro)
pickleRegistro.close()
print("*******************************************")
#------------------------------------------------------------------------------------------------------------------------------------
class Finestra(tkinter.Tk):
	...
	def crea_widgets(self):
		...
		self.txtSomma.configure(state = "readonly") #Disabilito l'input sulla entry che mostra la somma
	...
	def calcola(self):
		...
		if flag == 0:
			...
			self.somma.set(locale.currency(costo))
		...
		if flag == 1:
			...
			pickle.dump(datiRegistro + "DATI PRENOTAZIONE\nNome: " + nome + " Cognome: " + cognome + "\nTotale: " + nTOT + " Numero adulti: " + nADU + " Numero bambini: " + nBAM + "\nNumero notti: " + nNOT + "\nCamere singole: " + sing + " Camere matrimoniali: " + matr + "\nCosto: " + str(costo) + "€\n\n", pickling_on)
			pickling_on.close()
